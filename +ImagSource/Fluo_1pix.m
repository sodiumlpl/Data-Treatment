classdef Fluo_1pix < handle
    ...
    methods
        ...
        function obj = Fluo_1pix(pics_path)
            ...
            obj.pic_props(1).r_roi_ctr = 600;
            obj.pic_props(1).c_roi_ctr = 700;
            obj.pic_props(1).roi_wth = 300;
            
            obj.pic_props(1).pic_min = 0 ;
            obj.pic_props(1).pic_max = 100 ;
            
            obj.pic_props(2).r_roi_ctr = 640;
            obj.pic_props(2).c_roi_ctr = 350;
            obj.pic_props(2).roi_wth = 30;
            
            obj.pic_props(2).pic_min = 0 ;
            obj.pic_props(2).pic_max = 100 ;
            
            obj.pic_props(3).r_roi_ctr = 640;
            obj.pic_props(3).c_roi_ctr = 350;
            obj.pic_props(3).roi_wth = 30;
