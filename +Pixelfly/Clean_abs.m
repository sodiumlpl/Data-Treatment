classdef Clean_abs < handle
    ...
    methods
        ...
        function obj = Clean_abs(pics_path)
            ...
            obj.static_pic_props.magnification = Pixelfly.Default_parameters.magnification;
            
            obj.static_pic_props.r_rbc_ctr = Pixelfly.Default_parameters.Absorption_Corrected_r_rbc_ctr;
            obj.static_pic_props.c_rbc_ctr = Pixelfly.Default_parameters.Absorption_Corrected_c_rbc_ctr;
            obj.static_pic_props.rbc_wth = Pixelfly.Default_parameters.Absorption_Corrected_rbc_wth;
            
            obj.static_pic_props.use_rbc = Pixelfly.Default_parameters.Absorption_Corrected_use_rbc;
            
            % set default picture properties
            
            obj.pic_props(1).r_roi_ctr = Pixelfly.Default_parameters.Absorption_Corrected_r_roi_ctr;
            obj.pic_props(1).c_roi_ctr = Pixelfly.Default_parameters.Absorption_Corrected_c_roi_ctr;
            obj.pic_props(1).roi_wth = Pixelfly.Default_parameters.Absorption_Corrected_roi_wth;
            
            obj.pic_props(1).pic_min = Pixelfly.Default_parameters.Absorption_Corrected_pic_min ;
            obj.pic_props(1).pic_max = Pixelfly.Default_parameters.Absorption_Corrected_pic_max ;
            
            obj.pic_props(2).r_roi_ctr = Pixelfly.Default_parameters.Absorption_Signal_r_roi_ctr;
            obj.pic_props(2).c_roi_ctr = Pixelfly.Default_parameters.Absorption_Signal_c_roi_ctr;
            obj.pic_props(2).roi_wth = Pixelfly.Default_parameters.Absorption_Signal_roi_wth;
            
            obj.pic_props(2).pic_min = Pixelfly.Default_parameters.Absorption_Signal_pic_min;
            obj.pic_props(2).pic_max = Pixelfly.Default_parameters.Absorption_Signal_pic_max;
            
            obj.pic_props(3).r_roi_ctr = Pixelfly.Default_parameters.Absorption_Background_r_roi_ctr;
            obj.pic_props(3).c_roi_ctr = Pixelfly.Default_parameters.Absorption_Background_c_roi_ctr;
            obj.pic_props(3).roi_wth = Pixelfly.Default_parameters.Absorption_Background_roi_wth;
            
            obj.pic_props(3).pic_min = Pixelfly.Default_parameters.Absorption_Background_pic_min ;
            obj.pic_props(3).pic_max = Pixelfly.Default_parameters.Absorption_Background_pic_max ;
            
            obj.pic_props(4).r_roi_ctr = Pixelfly.Default_parameters.Absorption_pic_at_r_roi_ctr;
            obj.pic_props(4).c_roi_ctr = Pixelfly.Default_parameters.Absorption_pic_at_c_roi_ctr;
            obj.pic_props(4).roi_wth = Pixelfly.Default_parameters.Absorption_pic_at_roi_wth;
            
            obj.pic_props(4).pic_min = Pixelfly.Default_parameters.Absorption_pic_at_pic_min ;
            obj.pic_props(4).pic_max = Pixelfly.Default_parameters.Absorption_pic_at_pic_max ;
            
            obj.pic_props(5).r_roi_ctr = Pixelfly.Default_parameters.Absorption_pic_at_bg_r_roi_ctr;
            obj.pic_props(5).c_roi_ctr = Pixelfly.Default_parameters.Absorption_pic_at_bg_c_roi_ctr;
            obj.pic_props(5).roi_wth = Pixelfly.Default_parameters.Absorption_pic_at_bg_roi_wth;
            
            obj.pic_props(5).pic_min = Pixelfly.Default_parameters.Absorption_pic_at_bg_pic_min ;
            obj.pic_props(5).pic_max = Pixelfly.Default_parameters.Absorption_pic_at_bg_pic_max ;
            
            obj.pic_props(6).r_roi_ctr = Pixelfly.Default_parameters.Absorption_pic_wat_r_roi_ctr;
            obj.pic_props(6).c_roi_ctr = Pixelfly.Default_parameters.Absorption_pic_wat_c_roi_ctr;
            obj.pic_props(6).roi_wth = Pixelfly.Default_parameters.Absorption_pic_wat_roi_wth;
            
            obj.pic_props(6).pic_min = Pixelfly.Default_parameters.Absorption_pic_wat_pic_min ;
            obj.pic_props(6).pic_max = Pixelfly.Default_parameters.Absorption_pic_wat_pic_max ;
            
            obj.pic_props(7).r_roi_ctr = Pixelfly.Default_parameters.Absorption_pic_wat_bg_r_roi_ctr;
            obj.pic_props(7).c_roi_ctr = Pixelfly.Default_parameters.Absorption_pic_wat_bg_c_roi_ctr;
            obj.pic_props(7).roi_wth = Pixelfly.Default_parameters.Absorption_pic_wat_bg_roi_wth;
            
            obj.pic_props(7).pic_min = Pixelfly.Default_parameters.Absorption_pic_wat_bg_pic_min ;
            obj.pic_props(7).pic_max = Pixelfly.Default_parameters.Absorption_pic_wat_bg_pic_max ;
            ...
            addlistener(obj,'static_pic_props','PostSet',@obj.postset_static_pic_props);
        ...
        function pic_cor = get.pic_cor(obj)
            ...
            if isempty(obj.tmp_pic_cor)
                ...
                obj.tmp_pic_cor = -(Pixelfly.Default_parameters.pixel_size/obj.static_pic_props.magnification)^2/...
                    Pixelfly.Default_parameters.sigma0* ...
                    log(tmp);
...
%                     log(tmp);
    ...
    methods (Static = true)
        ...
        function obj = loadobj(pic)
            ...
            addlistener(pic,'pic_type','PostSet',@pic.postset_pic_type);
            
            addlistener(pic,'pic_props','PostSet',@pic.postset_pic_props);
            
            addlistener(pic,'static_pic_props','PostSet',@pic.postset_static_pic_props);
            
            % retrocompatibility 11/03/2015 update
            
            if isempty(pic.static_pic_props)
                
                pic.static_pic_props.magnification = Pixelfly.Default_parameters.magnification;
                
                pic.static_pic_props.use_rbc = 0;
                
                pic.static_pic_props.r_rbc_ctr = Pixelfly.Default_parameters.Absorption_Corrected_r_rbc_ctr;
                pic.static_pic_props.c_rbc_ctr = Pixelfly.Default_parameters.Absorption_Corrected_c_rbc_ctr;
                pic.static_pic_props.rbc_wth = Pixelfly.Default_parameters.Absorption_Corrected_rbc_wth;
